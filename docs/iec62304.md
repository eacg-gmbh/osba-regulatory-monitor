...
* Die IEC 62304 wird häufig in Kombination mit ISO 14971 (Risikomanagement) und IEC 82304-1 (Software als Medizinprodukt) angewendet
* Der [IMDRF Guidance on Software as a Medical Device (SaMD)](https://www.imdrf.org/documents/software-medical-device-samd-clinical-evaluation) gibt weitere Orientierung für softwarebasierte Medizinprodukte

### Tools & Werkzeuge

#### ALM / Software Lifecycle Management

| Tool | Lizenz | Problem / Zweck | Regulatorische Relevanz |
|------|--------|-----------------|------------------------|
| [Codebeamer](https://codebeamer.com/) | Kommerziell (SaaS) | ALM-Plattform mit eingebauten IEC 62304-Workflows; Requirements, Risiko, Test, Traceability | IEC 62304, ISO 14971, MDR |
| [Polarion ALM](https://polarion.plm.automation.siemens.com/) | Kommerziell | Requirements und Testmanagement mit vollständiger Rückverfolgbarkeit | IEC 62304: Konfigurationsmanagement, V&V |
| [Jama Connect](https://www.jamasoftware.com/) | Kommerziell (SaaS) | Requirements Management + Traceability für regulierte Branchen | IEC 62304 Sections 5–7 |
| [rdm (Regulatory Document Manager)](https://github.com/innolitics/rdm) | Open Source (MIT) | Generiert IEC 62304-konforme Dokumente aus Code-Repositories; Markdown-basiert | IEC 62304 vollständig |

#### Risikomanagement (ISO 14971 Integration)

| Tool | Lizenz | Problem / Zweck | Regulatorische Relevanz |
|------|--------|-----------------|------------------------|
| [Greenlight Guru](https://www.greenlight.guru/) | Kommerziell (SaaS) | Integriertes QMS + Risikomanagement für Medizinproduktesoftware | IEC 62304 §7, ISO 14971 |
| [risk-wizard](https://github.com/openmedical/risk-wizard) | Open Source (MIT) | CLI-Tool zur Erstellung von ISO 14971-konformen Risikotabellen aus YAML | ISO 14971, IEC 62304 §7 |

#### Qualitätssicherung & Test Management

| Tool | Lizenz | Problem / Zweck | Regulatorische Relevanz |
|------|--------|-----------------|------------------------|
| [TestRail](https://www.testrail.com/) | Kommerziell (SaaS) | Testmanagement mit Traceability zu Anforderungen; Audit-Trail | IEC 62304 §5.7: Software-Verifizierung |
| [Xray für Jira](https://www.getxray.app/) | Kommerziell (Plugin) | Test Management in Jira mit Anforderungs-Traceability | IEC 62304: Testplanung und -durchführung |
