...
* Die **TrustSource Community Edition** (AGPL, [GitHub](https://github.com/trustsource/ts-core-ce)) adressiert die Anforderungen der Spezifikation umfassend: SBOM-Erstellung und -Versionierung, kontinuierliches Vulnerability Management sowie CSAF-basierte Kommunikation von Security Advisories.
